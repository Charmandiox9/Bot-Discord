...
export async function getYoutubePlaylistQueries(url: string): Promise<Partial<QueueItem>[]> {
  try {
    ...
    throw new Error('No pude leer la playlist de YouTube. Puede que sea privada.');
  }
}
